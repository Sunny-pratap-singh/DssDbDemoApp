...
namespace DssDbDemoApp.Controllers
{
    public class EmployeesController : Controller
    {
        private readonly DssDbDemoAppContext _context;

        public EmployeesController(DssDbDemoAppContext context)
        {
            _context = context;
        }
        ...
        {
            var dssDbDemoAppContext = _context.Employees.Include(e => e.Department);
            return View(await dssDbDemoAppContext.ToListAsync());
        }
